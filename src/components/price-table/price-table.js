                    ...
                    <table className='div-inner-table'>
                        <tbody>
                            ...
                            //const { id, name, age, email } = student //destructuring
                                ...
                                if (x_pclose_formatted >= x_close_formatted ){
                                    gain_loss = 'gain'

                                } else {
                                    gain_loss = 'loss'
                                }
                                change_calc = parseFloat(x_pclose_formatted - x_close_formatted).toFixed(2);
                                gain_loss = 'div-table-col-close ' + gain_loss;
                                var percent = parseFloat((change_calc/x_close_formatted)*  100).toFixed(2);
                                ...
                                <tr className='alternating' key={id}>
                                    ...
                                    <td className='div-table-col-close'>{ x_close_formatted }</td>
                                    ...
                                    <td className={gain_loss}>{x_pclose_formatted}</td>
